...
from app.models.schemas import SearchResultItemSchema, SearchResultSchema, ContextResultSchema
...
class RAGService:
    ...
    async def _vector_search(
        ...
        for point in scored:
            ...
            items.append(SearchResultItemSchema(
                chunkId=chunk.id,
    ...
    async def _bm25_search(
        ...
        q = q.filter(Chunk.statut_juridique.in_(["VIGUEUR", "VIGUEUR_ETEN"]))
        chunks = q.limit(500).all()
